...
const Footer = () => {
    return (
        <div>
            <footer className="px-4 divide-y rounded-lg bg-purple-300 mt-10 dark:text-gray-800">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl  font-semibold">World Tour</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4 mx-auto">
			...
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-gray-900">Conditions</h3>
				<ul className="space-y-1">
					<li>
					...
					<li>
						<a rel="noopener noreferrer" href="#">Safety with travel</a>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
